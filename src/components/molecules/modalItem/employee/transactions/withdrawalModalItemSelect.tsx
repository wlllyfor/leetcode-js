...
const WithdrawalModalItemSelect = (): ReactElement => {
  ...
  return (
    <ContentAreaWrapper>
      <FlexWrapperLg>
        <SelectGroup44 text={"顧客出金種別"} options={options1} isMulti={false} isRequired />{" "}
      </FlexWrapperLg>
    </ContentAreaWrapper>
  );
};

export default WithdrawalModalItemSelect;
