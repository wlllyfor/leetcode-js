...
import TableDataProducts from "@/components/atoms/table/tableDataProducts";
...
const CaseProductItem = ({
  ...
  return (
    <TableRow>
      ...
      <TableDataTexts texts={productIdDataTexts} />
...
export default CaseProductItem;
