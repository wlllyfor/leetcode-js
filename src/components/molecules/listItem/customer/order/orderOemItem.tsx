...
import CountableInputOfQuantity from "../../../inputs/countableInputOfQuantity";
...
const OrderOemItem = ({
  ...
  }, [ name, productUrl, sku, unitPrice, quantity, variation, publicRemarks, publicRemarksFile, isFirstRender, handleOnChangeOrderOemItem, orderProduct ]);
